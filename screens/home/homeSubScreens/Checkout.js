    ...
    const Tips=({setCurrentTipfn, tip})=>{
        return (
            <TouchableOpacity onPress={()=>setCurrentTipfn(tip)} >
                <View style={{borderRadius:5,backgroundColor:(tip==currentTip?'#FF3737':'white'),borderColor:"#A6A6A6",borderWidth:1,width:65,marginRight:30,height:30,justifyContent:'center'}}>
