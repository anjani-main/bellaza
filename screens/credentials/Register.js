    ...
    return (
        ...
        <Image source={require('../../statics/Bellazza.png')} style={{alignSelf:'center',marginTop:10}}/>
            ...
            <View style={{flexDirection:'row',justifyContent:'space-evenly',width:'80%',alignSelf:'center',alignItems:'center'}}>
                ...
                <View style={{backgroundColor:(gender=='male'?'#FF3737':'white'),borderRadius:100,width:40,height:40,justifyContent:'center',alignItems:'center',borderColor:'#FF3737',borderWidth:1}}><Text><FontAwesome5 onPress={()=>setGender('male')} name={'male'}  size={26} style={{color:(gender=='male'?'white':'#FF3737')}} /></Text></View>
            
                <Text style={{fontWeight:'500',fontSize:13,lineHeight:20,...style.tStyle}}>or</Text>
                <View style={{backgroundColor:(gender=='female'?'#FF3737':'white'),borderRadius:100,width:40,height:40,justifyContent:'center',alignItems:'center',borderColor:'#FF3737',borderWidth:1}}><Text><FontAwesome5 onPress={()=>setGender('female')} name={'female'}  size={26} style={{color:(gender=='female'?'white':'#FF3737')}} /></Text></View>
            </View>
